...
<%
	...
	List<User> posts = userService.UntilVisitUsers(myPage);
...
<body>
  ...
  <div id="fullweb">
     ...
     <div class="main">
       <div class="mainB" id="mainB"><h1>최근 방문 회원순</h1>
            <div class="mainSerch">
           ...
           <div class="memberNum">
			...
			<ul class="pagination">
				<c:if test="${pageMaker.prev}">
					<li><a href="adminUntilVisit.jsp?currentPage=${pageMaker.startPage-1}&#mainAa1">&laquo;</a></li>
				</c:if>
				
				<c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="idx">
					<li <c:out value ="${pageMaker.page.currentPage==idx? 'class=active':'' }"/>>
						<a href="adminUntilVisit.jsp?currentPage=${idx}&#mainbb">${idx}</a>
					</li>
				</c:forEach>
				
				<c:if test="${pageMaker.next}">
					<li><a href="adminUntilVisit.jsp?currentPage=${pageMaker.endPage+1}&#mainAa1">&raquo;</a></li>
				</c:if>
			</ul>
