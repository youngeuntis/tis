			...
			<div class="mainB" id="mainB">
				...
				<div class="mainSerch">
					...
					<div class="mainSerch2">
						<input id="search" style="width: 170px; height: 22px;"
							search" type="search" name="search_member" placeholder="검색"
							maxlength="255">
					</div>
					...
					<div class="memberNumin">
						...
						<ul class="pagination">
							<c:if test="${pageMaker.prev}">
								<li><a
									href="adminFull.jsp?currentPage=${pageMaker.startPage-1}&#mainAa1">&laquo;</a></li>
							</c:if>
							...
							<c:if test="${pageMaker.next}">
								<li><a
									href="adminFull.jsp?currentPage=${pageMaker.endPage+1}&#mainAa1">&raquo;</a></li>
							</c:if>
						</ul>
					</div>
				</div>
