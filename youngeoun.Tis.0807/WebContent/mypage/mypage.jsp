...
<link rel="stylesheet" href="../res/mypage/css/mypage.css">
<script type="text/javascript" src="../res/mypage/js/custom.js"></script>
<script	src="https://unpkg.com/masonry-layout@4/dist/masonry.pkgd.min.js"></script>
<link href="http://maxcdn.bootstrapcdn.com/font-awesome/4.2.0/css/font-awesome.min.css"
	rel="stylesheet">
<script src="../res/mypage/js/modernizr.custom.js"></script>
...
<body>
	...
	<script src="../res/mypage/js/cbpHorizontalMenu.min.js"></script>
	<script>$(function() {cbpHorizontalMenu.init();});</script>

	<!--main_login-->
	<script
		src="http://cdnjs.cloudflare.com/ajax/libs/jquery/2.2.2/jquery.min.js"></script>
	<script src="../res/mypage/js/index.js"></script>
