        ...
        <div class="travel_container">
				<!-- #region Jssor Slider Begin -->
                	...
                	BlogMapper blogMapper = Configuration.getMapper(BlogMapper.class);
              		...
              		String index = "";
              		String indexCountry ="";
              		List<Blog> blogs = blogMapper.getBlogListNoPara();
              		...
              		/* if(continent.equals("대한민국")) index = "c1";
    				else if(continent.equals("유럽")) index = "c2";
    				else if(continent.equals("미대양주")) index = "c3";
    				else if(continent.equals("아시아")) index = "c1";
              		
              		TravelMapper travelMapper = Configuration.getMapper(TravelMapper.class);
              		List<Country> countries = travelMapper.getCountryList(index);
              		...
              		if(country!=null && !country.equals("")) blogs = blogMapper.getBlogList(indexCountry);
              		else blogs = blogMapper.getBlogListNoPara();
              		
              		for(Blog blog : blogs){
              			if(blog.getBlogNum()==Integer.parseInt(blogNum)){
              				selectBlog = blog;
              			}
              		}  */
                %>
            ...
            <div class="travel_content">
                ...
                <div class="content_buttons">
                    <a href="02BlogMain.jsp" class="action-button shadow animate blue">수정</a>
