...
<link rel="stylesheet" href="../res/review/css/styleMain.css">
<script type="text/javascript" src="../res/review/js/custom.js"></script>
<script	src="https://unpkg.com/masonry-layout@4/dist/masonry.pkgd.min.js"></script>
<link href="http://maxcdn.bootstrapcdn.com/font-awesome/4.2.0/css/font-awesome.min.css"
	rel="stylesheet">
<script src="../res/review/js/modernizr.custom.js"></script>
	...
	<div id="fullweb">
						...
						<section class="modal signup badge-overlay-signin">
							...
							<section id="signup">
								...
								<div class="social-signup">
									<a class="btn-connect-option facebook badge-facebook-connect"
										href="#" onclick="">Facebook</a> <a
										class="btn-connect-option google-plus" href="" onclick="">Google</a>
								</div>
								<form id="login-email" class="badge-login-form" action=""
									...
									<div class="field">
										<label for="jsid-login-email-name">Email</label> <input
		...
		<div class="slideshow-container">
			...
			<div class="mySlides fade" style="display: block;">
				<img src="img/trip/g.jpg" style="width: 100%;">
			</div>

			<div class="mySlides fade">
				<img src="img/trip/m.jpg" style="width: 100%;">
			</div>

			<div class="mySlides fade">
				<img src="img/trip/p.jpg" style="width: 100%;">
			</div>

			<div class="mySlides fade">
				<img src="img/trip/pr.jpg" style="width: 100%;">
			</div>
		...
		<main>
		 <div class="selectbox">
			...
			<table class="type11">
                    ...
                    <img src="../res/review/img/123.jpg" onclick="document.all.uploadFile1.click();"></p></th>
            </table>
            <table class="type12">   
                <td>
            ...
            <table class="type13">
					<th>글 내용안의 동영상 사진 음악 등 업로드
                        ...
                        <img src="../res/review/img/123.jpg"
			...
			<table class="type15">
				<th><a href="review03.jsp"/>등록</th>
            </table>
            <table class="type15">
                <th><a href="review01.jsp"/>취소</th>
			</table>
		</main>
		...
		<script src="../res/review/js/cbpHorizontalMenu.min.js"></script>
		<script>$(function() {cbpHorizontalMenu.init();});</script>

		<!--main_login-->
		<script
			src='http://cdnjs.cloudflare.com/ajax/libs/jquery/2.2.2/jquery.min.js'></script>
		<script src="../res/review/js/index.js"></script>
</body>
</html>